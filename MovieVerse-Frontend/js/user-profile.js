...
function updateProgressCircles(movieRating, triviaScore) {
  ...
  setProgress(
    document.getElementById("avgMovieRatingCircle"),
    document.getElementById("avgMovieRatingText"),
    movieRatingPercent,
  );
  setProgress(
    document.getElementById("avgTriviaScoreCircle"),
    document.getElementById("avgTriviaScoreText"),
    triviaScorePercent,
  );
}
...
document.getElementById("container1").addEventListener("click", async () => {
  ...
  try {
    ...
    const triviaStats = parseInt(
      localStorage.getItem("currentAverageTriviaScore"),
      10,
    );
...
async function loadProfile(
  ...
  try {
    ...
    if (triviaStats.totalAttempted > 0) {
      averageTriviaScore =
        (triviaStats.totalCorrect / triviaStats.totalAttempted) * 100;
    }
    ...
    document.getElementById("favoriteGenresDisplay").innerHTML =
      `<strong>Favorite Genres:</strong> ${profile.favoriteGenres}`;
    document.getElementById("locationDisplay").innerHTML =
      `<strong>Location:</strong> ${profile.location}`;
    document.getElementById("favoriteMovieDisplay").innerHTML =
      `<strong>Favorite Movie:</strong> ${profile.favoriteMovie}`;
    document.getElementById("hobbiesDisplay").innerHTML =
      `<strong>Hobbies:</strong> ${profile.hobbies}`;
    document.getElementById("favoriteActorDisplay").innerHTML =
      `<strong>Favorite Actor:</strong> ${profile.favoriteActor}`;
    document.getElementById("favoriteDirectorDisplay").innerHTML =
      `<strong>Favorite Director:</strong> ${profile.favoriteDirector}`;
    document.getElementById("personalQuoteDisplay").innerHTML =
      `<strong>Personal Quote:</strong> ${profile.personalQuote}`;
    ...
    .addEventListener("click", async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          profile.hobbies =
            profile.hobbies.length > 0 ? profile.hobbies : ["N/A"];
        }
        ...
        document.getElementById("editDob").value =
          profile.dob || defaultDOBString;
        document.getElementById("editBio").value = profile.bio;
        document.getElementById("editFavoriteGenres").value =
          profile.favoriteGenres.join(", ");
        document.getElementById("editLocation").value = profile.location;
        document.getElementById("editFavoriteMovie").value =
          profile.favoriteMovie;
        document.getElementById("editHobbies").value =
          profile.hobbies.join(", ");
        document.getElementById("editFavoriteActor").value =
          profile.favoriteActor;
        document.getElementById("editFavoriteDirector").value =
          profile.favoriteDirector;
        document.getElementById("editPersonalQuote").value =
