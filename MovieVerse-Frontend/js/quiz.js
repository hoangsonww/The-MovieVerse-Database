...
const questionBank = [
  ...
  {
    question:
      "What was the highest-grossing movie of all time before the release of 'Avatar'?",
  ...
  {
    question:
      "Who played the character of John McClane in the Die Hard movie series?",
    options: ["Arnold Schwarzenegger", "Sylvester Stallone", "Bruce Willis"],
    answer: "Bruce Willis",
  },
  {
    question:
      "What movie is based on a novel by Stephen King and features a character named Jack Torrance?",
  ...
  {
    question:
      "Which 1997 science fiction movie stars Will Smith and Tommy Lee Jones?",
  ...
  {
    question:
      "In which movie does Tom Cruise perform his own stunts climbing the Burj Khalifa?",
    options: [
  ...
  {
    question:
      "What is the name of the fictional African country where 'Black Panther' is set?",
  ...
  {
    question:
      "In 'The Hunger Games', what district do Katniss and Peeta represent?",
  ...
  {
    question:
      "Which film features a famous dance scene with Uma Thurman and John Travolta?",
  ...
  {
    question:
      "What is the real name of the Black Panther in the Marvel Cinematic Universe?",
  ...
  {
    question:
      "In which film is the fictional mineral 'Unobtainium' sought after?",
    options: ["Avatar", "The Core", "Transformers"],
    answer: "Avatar",
  },
  {
    question:
      "What is the name of the fictional city where the Batman movies take place?",
  ...
  {
    question:
      "Which movie features a dystopian future divided into faction-based societies?",
  ...
  {
    question:
      "In 'The Terminator', what is the name of the company that created Skynet?",
  ...
  {
    question:
      "What is the highest grossing film of all time (not adjusted for inflation) as of 2023?",
    options: ["Avengers: Endgame", "Avatar", "Titanic"],
    answer: "Avatar",
  },
  {
  ...
  {
    question:
      "Which movie did Leonardo DiCaprio win his first Oscar for Best Actor?",
    options: ["The Revenant", "The Wolf of Wall Street", "Inception"],
    answer: "The Revenant",
  },
  {
    question:
      "In which film does the character Maximus Decimus Meridius appear?",
    options: ["300", "Gladiator", "Troy"],
    answer: "Gladiator",
  },
  {
    question:
      "What is the name of the fictional British spy in the film series created by Ian Fleming?",
    options: ["James Bond", "Jason Bourne", "Jack Ryan"],
    answer: "James Bond",
  },
  {
    question:
      "Which movie won the Academy Award for Best Animated Feature in 2021?",
  ...
  {
    question:
      "What 2009 film is known for pioneering modern 3D cinema technology?",
    options: ["Inception", "Avatar", "The Hurt Locker"],
    answer: "Avatar",
  },
  {
    question:
      "Which 2012 film features a protagonist who survives a shipwreck with a tiger?",
  ...
  {
    question:
      "Which film features the character Sarah Connor, who is central to the plot?",
  ...
  {
    question:
      "Who directed 'Titanic', which won the Academy Award for Best Picture in 1997?",
  ...
  {
    question:
      "What iconic 1980s movie features the quote, 'Say hello to my little friend!'?",
  ...
  {
    question:
      "What movie, featuring a journey to Mordor, won the Academy Award for Best Picture in 2003?",
    options: [
  ...
  {
    question:
      "What classic film was remade in 2005 starring Naomi Watts and Jack Black?",
  ...
  {
    question:
      "Who played the role of Clarice Starling in the film 'The Silence of the Lambs'?",
  ...
  {
    question:
      "What 1975 thriller is known for its menacing shark and famous soundtrack?",
    options: ["Deep Blue Sea", "Jaws", "Sharknado"],
    answer: "Jaws",
  },
  {
    question:
      "Which film did Tom Hanks win his first Academy Award for Best Actor?",
  ...
  {
    question:
      "Who directed 'Avatar', the groundbreaking sci-fi movie released in 2009?",
    options: ["James Cameron", "George Lucas", "Steven Spielberg"],
    answer: "James Cameron",
  },
  {
    question:
      "Which 1988 animated film features a dystopian future and psychic powers?",
  ...
  {
    question:
      "Which film features a group of friends who use a map to find a pirate's treasure?",
    options: ["The Goonies", "Treasure Island", "Pirates of the Caribbean"],
    answer: "The Goonies",
  },
  {
    question:
      "What was the first animated film to receive a Best Picture nomination at the Oscars?",
  ...
  {
    question:
      "What 2000 film, directed by Ridley Scott, features a Roman general turned gladiator?",
  ...
  {
    question:
      "What 1993 science fiction film directed by Steven Spielberg features dinosaurs brought back to life through cloning?",
  ...
  {
    question:
      "Which 2010 film directed by Christopher Nolan explores dream-sharing technology?",
    options: ["Inception", "Interstellar", "Memento"],
    answer: "Inception",
  },
  {
    question:
      "What film series features a secret British spy agency known as Kingsman?",
    options: ["James Bond", "Kingsman", "Johnny English"],
    answer: "Kingsman",
  },
  {
    question:
      "Who played the role of Jack Sparrow in the 'Pirates of the Caribbean' film series?",
    options: ["Johnny Depp", "Orlando Bloom", "Keira Knightley"],
    answer: "Johnny Depp",
  },
  {
    question:
      "Which 2001 film, based on a J.R.R. Tolkien novel, follows a hobbit's quest to destroy a powerful ring?",
    options: [
      "The Hobbit",
      "The Lord of the Rings: The Fellowship of the Ring",
      "The Lord of the Rings: The Two Towers",
  ...
  {
    question:
      "Which 2017 film is based on a DC Comics character and set during World War I?",
    options: [
      "Wonder Woman",
  ...
  {
    question:
      "Which 2016 film tells the story of a group of rebels who plan to steal plans for the Death Star?",
    options: [
  ...
  {
    question:
      "What is the name of the fictional African kingdom in 'Coming to America'?",
  ...
  {
    question:
      "What 1980s movie is known for the quote 'Nobody puts Baby in a corner'?",
    options: ["Dirty Dancing", "Footloose", "Flashdance"],
    answer: "Dirty Dancing",
  },
  {
    question:
      "What 1995 film directed by Michael Mann stars Robert De Niro and Al Pacino?",
    options: ["Heat", "The Godfather", "Scarface"],
    answer: "Heat",
  },
  {
    question:
      "Who starred as the titular character in the 2014 film 'Maleficent'?",
    options: ["Angelina Jolie", "Charlize Theron", "Nicole Kidman"],
    answer: "Angelina Jolie",
  },
  {
    question:
      "Which film is about a board game that becomes real for the players?",
    options: ["Zathura", "Jumanji", "The Game"],
    answer: "Jumanji",
  },
  {
    question:
      "In which movie does a group of archaeologists find a frozen prehistoric man?",
...
document
  .getElementById("regenerate-questions")
  .addEventListener("click", generateRandomQuestions);
  ...
  .addEventListener("submit", function (event) {
    ...
    if (answeredQuestions < 10) {
      const confirmSubmit = confirm(
        `You have only answered ${answeredQuestions} questions. Are you sure you want to submit?`,
      );
      if (!confirmSubmit) {
        return;
      }
...
function calculateAndDisplayResults() {
  ...
  const currentUserEmail =
    localStorage.getItem("currentlySignedInMovieVerseUser") || null;
...
function displayResults(score) {
  ...
  document.getElementById("result-text").textContent =
    `Your score is ${score} out of 10 (${accuracy.toFixed(1)}% accuracy)`;
