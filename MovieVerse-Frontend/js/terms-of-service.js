...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function clearSelection() {
    const results =
      searchResultsContainer.getElementsByClassName("search-result-card");
    ...
    if (e.key === "ArrowDown" || (e.key === "Tab" && !e.shiftKey)) {
      ...
      if (
        ...
        searchResultsContainer
          .getElementsByClassName("search-result-card")
          [selectedIndex].click();
      } else if (
        selectedIndex ===
        searchResultsContainer.getElementsByClassName("search-result-card")
...
function getMovieCode() {
  return (
    atob(movieCode1.part1) + atob(movieCode1.part2) + atob(movieCode1.part3)
  );
}
