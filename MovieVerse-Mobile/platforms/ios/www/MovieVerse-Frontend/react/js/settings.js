...
document.addEventListener('DOMContentLoaded', () => {
    ...
    customImages.forEach((image, index) => {
      ...
      imageContainer.addEventListener('click', e => {
        if (e.target !== checkbox) {
          // Prevent checkbox click event from toggling twice
  ...
  function loadSettings() {
    ...
    const availableBackgrounds = [
      ...
      '../../images/universe-11.webp',
      '../../images/universe-12.webp',
      '../../images/universe-13.webp',
      '../../images/universe-14.webp',
      '../../images/universe-15.webp',
      '../../images/universe-16.webp',
      '../../images/universe-17.webp',
      '../../images/universe-18.webp',
      '../../images/universe-19.webp',
      '../../images/universe-20.webp',
      '../../images/universe-21.webp',
      '../../images/universe.webp',
      '../../images/universe-23.webp',
      '../../images/black.webp',
      '../../images/grey.webp',
      '../../images/blue.webp',
      '../../images/silver.webp',
    ...
    if (fileInput && fileInput.files.length > 0) {
      ...
      if (file.size > 204800) {
        ...
        resizeImage(file, 204800, (resizedDataUrl, err) => {
          if (err) {
            alert(
              `Error resizing the image due to a limitation in your browser. Browser error: ${err.message} Your image might still appear as the background, but it will not be stable. We recommend deleting it and then using a different browser or uploading an image smaller than 1MB.`
            );
            return;
          }
