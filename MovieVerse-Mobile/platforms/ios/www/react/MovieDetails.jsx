    ...
    render() {
        ...
        return (
            <div>
                ...
                <p><strong>Reviews:</strong> {details.reviews.map(review => (
                    <div key={review.id}>
                ...
                <p><strong>Similar Movies:</strong> {details.similarMovies.join(', ')}</p>
                <p><strong>Sequels:</strong> {details.sequels.join(', ')}</p>
                <p><strong>Prequels:</strong> {details.prequels.join(', ')}</p>
            </div>
        );
    }
}
