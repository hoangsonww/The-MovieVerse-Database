...
registerApplication(
    'about',
    () => System.import('http://localhost:8083/about.js'),
    pathPrefix('/about')
);
...
registerApplication(
    'quiz',
    () => System.import('http://localhost:8084/quiz.js'),
    pathPrefix('/contact')
);
...
registerApplication(
    'favorites',
    () => System.import('http://localhost:8085/favorites.js'),
...
registerApplication(
    'movie-match',
    () => System.import('http://localhost:8086/movie-match.js'),
    pathPrefix('/movie-match')
);

// Load React Microfrontend for the movie timeline page
registerApplication(
    'movie-timeline',
    () => System.import('http://localhost:8087/movie-timeline.js'),
...
registerApplication(
    'navbar',
    () => System.import('http://localhost:8082/navbar.js'),
    pathPrefix('/navbar')
  );
