...
async function fetchMovieDetails(movieId) {
    ...
    const url = `https://api.themoviedb.org/3/movie/27205?api_key=${code}&append_to_response=credits,keywords,similar`;
    const url2 = `https://api.themoviedb.org/3/movie/27205?api_key=${code}&append_to_response=videos`;
    const imdbUrl = `https://api.themoviedb.org/3/movie/27205?api_key=${code}&append_to_response=external_ids`;
