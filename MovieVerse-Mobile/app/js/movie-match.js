...
async function showMovieOfTheDay() {
  ...
  const url = `https://api.themoviedb.org/3/discover/movie&sort_by=vote_average.desc&vote_count.gte=100&primary_release_year=${year}&vote_average.gte=7`;
...
function findMovieMatch(mood, genre, period) {
  ...
  const filteredMovies = movieDatabase.filter(movie => movie.mood === mood && movie.genre === genre && movie.period === period);
