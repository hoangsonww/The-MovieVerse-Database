...
def parse_movie_data(html_content):
    ...
    movie_data = {
        ...
        'rotten_tomatoes_rating': int(
            soup.find('span', class_='movie-rotten-tomatoes-rating').text.strip().replace('%', '')),
        'rotten_tomatoes_reviews': int(
            soup.find('span', class_='movie-rotten-tomatoes-reviews').text.strip().replace(',', '')),
        'rotten_tomatoes_fresh': int(
            soup.find('span', class_='movie-rotten-tomatoes-fresh').text.strip().replace('%', '')),
    }
    return movie_data
